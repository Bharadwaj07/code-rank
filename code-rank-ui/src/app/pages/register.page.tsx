                    ...
                    <div className="-space-y-px rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="email"
                                required
                                className="relative block w-full border-t-0 border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
